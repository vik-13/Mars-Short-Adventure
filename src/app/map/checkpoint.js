function Checkpoint(x, y) {
  const g = [[[1,108,0,74,35,74,35,109],color.black,color.health,1],[[0,74,0,37,35,37,35,74],color.black,color.black,1],[[1,37,1,1,35,0,35,38],color.black,color.health,1],[[35,1,73,1,71,36,35,38],color.black,color.black,1],[[73,1,107,1,109,38,72,37],color.black,color.health,1],[[71,37,71,73,108,73,108,38],color.black,color.black,1],[[71,73,72,109,107,108,107,73],color.black,color.health,1]];
