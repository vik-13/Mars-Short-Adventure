...
function Door(type, x, y) {
  const doorColor = colors[type - 21];
  const g = [[[1,0,0,80,33,79,33,0],color.black, color.black,1],[[10,8,5,25,16,24,18,13],color.black,doorColor,1],[[24,18,21,39,28,33,29,21],color.black,doorColor,1],[[5,32,3,77,21,75,12,58,17,27],color.black,doorColor,1],[[24,53,19,60,29,70,30,50],color.black,doorColor,1]];
