function Key(type, x, y, staticKey) {
  ...
  const color = keyColors[type - 25];
  const g = [[[0,0,0,24,18,24,18,0],"#000000","black",1],[[3,2,1,7,5,6,5,3],"#000000",color,1],[[10,2,14,8,16,6,16,2],"#000000",color,1],[[2,9,1,23,13,22,8,16,6,8],"#000000",color,1],[[13,11,8,13,17,19,15,10],"#000000",color,1]];
